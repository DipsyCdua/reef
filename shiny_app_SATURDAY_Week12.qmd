        ...
        fluidRow(
          column(width = 12,
            box(
              ...
              HTML("
                <h4 style='margin-bottom:0.5em;'>What you’re looking at</h4>
                <p>
                  This interactive map shows the average Degree Heating Weeks (DHW), Sea Surface
                  Temperature (SST) or Sea Surface Temperature Anomaly (SSTA) for points across
                  the Great Barrier Reef in the selected year.  Use the controls on the left to
                  pick a year, variable, and shelf zone—then explore spatial patterns and
...
new_server <- function(input, output, session) {
  ...
  output$map_ui <- renderUI({
    ...
    box(
      title       = paste("Map — Year:", input$year),
      width       = NULL,
      status      = "primary",
      solidHeader = TRUE,
